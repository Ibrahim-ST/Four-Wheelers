      ...
      <section class="bg-white dark:bg-gray-900 bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern.svg')] dark:bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/hero-pattern-dark.svg')]">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 z-10 relative">
          ...
          >
            ...
            Fuel your passion for toy cars with the latest news, reviews, and thrilling adventures
            </span>
            <svg
              aria-hidden="true"
              class="ml-2 w-5 h-5"
          ...
          Revved Up Weekly: Fueling Fun with Cars!
          </h1>
          <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48 dark:text-gray-200">
          Unleash your inner mechanic with tips on customizing, maintaining, and enhancing your toy car collection. Enter a world of endless fun and exhilaration with our wide selection of toy cars and thrilling adventures.
          </p>
